...
import com.ricky.minhaempresa.presentation.balanco.components.CardEntradasSaidas
    ...
    Card(
        ...
        Column(modifier = modifier) {
            ...
            Column(
                ...
                Text(
                    text = if (faturamentos.totalSaida == BigDecimal(0.0)) "Não teve saídas" else "Total Saídas = R$${faturamentos.totalEntrada}",
                    style = MaterialTheme.typography.bodyLarge,
                    color = Color.Red
                )
            }
